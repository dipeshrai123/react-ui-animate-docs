    ...
    <header className={clsx('hero hero--primary', styles.heroBanner)}>
      <div className="container">
        ...
        <div className={styles.installation}>
          ...
          <MdContentCopy
            onClick={() =>
              navigator.clipboard.writeText('npm i react-ui-animate')
            }
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Create smooth, high-performance animations with React UI Animate's
          easy-to-use API—from simple transforms to advanced interactive
          gestures.
        </div>
