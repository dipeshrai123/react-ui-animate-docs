...
- Learn about [Hover Animations](./hover) for mouse interactions
- Explore [Press Animations](./press) for click feedback
- Check out [View Animations](./view) for scroll-triggered effects
