...
- Learn about [Advanced Presence](./advanced) for complex exit animations
- Explore [Enter Animations](../concept/animate#animate-prop) for mount animations
- Check out [Real-World Examples](../examples/modal) for complete implementations
