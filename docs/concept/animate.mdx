...
- See [Presence & Exit](../presence/basics) for animating components entering/leaving the DOM
- Check out [Interactive Animations](../interactive/hover) for more on declarative props
