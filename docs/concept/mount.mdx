...
:::warning Deprecated
The `<Mount>` component has been replaced with the [`Presence`](../presence/basics) component in version 5.3.0. Please use `Presence` for new code.

See [Presence & Exit Animations](../presence/basics) for the new API.
:::
