...
```bash
npm install react-ui-animate@5.3.0-next.1
```

or with yarn:

```bash
yarn add react-ui-animate@5.3.0-next.1
```
...
3. **[Presence & Exit](./presence/basics)** - Animate components entering/leaving the DOM (essential for modals, dropdowns, etc.)
4. **[Interactive Animations](./interactive/hover)** - Use `hover`, `press`, `focus`, and `view` props
5. **[Gestures](./gesture/overview)** - Build drag, scroll, and wheel interactions
6. **[Advanced Topics](./advanced/interpolation)** - Interpolation, combining values, and more
7. **[Real-World Examples](./examples/modal)** - Complete implementations

## Your First Animation

Let's build a complete, interactive example:
...
- Click "Animate" to see a smooth spring animation
- Click "Reset" to see a timing-based transition back
...
- **[Presence & Exit](./presence/basics)** - Learn how to animate components entering/leaving the DOM
- **[Interactive Animations](./interactive/hover)** - Use declarative props for common interactions
