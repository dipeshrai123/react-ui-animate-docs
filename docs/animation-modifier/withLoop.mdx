---
sidebar_position: 7
id: animation-modifiers-withLoop
title: withLoop
---
...
#### Parameters
- **animation**: The animation descriptor you want to repeat (eg: ([withSpring](animation-modifiers-withSpring), [withTiming](animation-modifiers-withTiming), [withDecay](animation-modifiers-withDecay), etc.) ).
