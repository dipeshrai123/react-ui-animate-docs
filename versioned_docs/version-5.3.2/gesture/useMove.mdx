...
import Demo_gesture_useMove_BasicSetup from '@site/src/examples/5.3.2/gesture/useMove/BasicSetup';
import Code_gesture_useMove_SingleElements from '!!raw-loader!@site/src/examples/5.3.2/gesture/useMove/SingleElements.tsx';
import Demo_gesture_useMove_SingleElements from '@site/src/examples/5.3.2/gesture/useMove/SingleElements';
...
import Demo_gesture_useMove_MultipleElements from '@site/src/examples/5.3.2/gesture/useMove/MultipleElements';
...
<CodeExample
  demo={Demo_gesture_useMove_BasicSetup}
...
<CodeExample
  demo={Demo_gesture_useMove_SingleElements}
...
<CodeExample
  demo={Demo_gesture_useMove_MultipleElements}
