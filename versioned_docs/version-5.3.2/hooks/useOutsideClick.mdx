...
import Code_hook_useOutsideClick_BasicExample from '!!raw-loader!@site/src/examples/5.3.2/hook/useOutsideClick/BasicExample.tsx';
import Demo_hook_useOutsideClick_BasicExample from '@site/src/examples/5.3.2/hook/useOutsideClick/BasicExample';
