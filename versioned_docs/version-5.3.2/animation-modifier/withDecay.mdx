...
import Code_modifier_withDecay_BasicExample from '!!raw-loader!@site/src/examples/5.3.2/modifier/withDecay/BasicExample.tsx';
import Demo_modifier_withDecay_BasicExample from '@site/src/examples/5.3.2/modifier/withDecay/BasicExample';
...
- Explore [useScroll](../gesture/useScroll) for scroll-based animations
