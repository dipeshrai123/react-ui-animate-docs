...
import Code_core_interpolation_BasicExample from '!!raw-loader!@site/src/examples/6.0.0/core/interpolation/BasicExample.tsx';
import Demo_core_interpolation_BasicExample from '@site/src/examples/6.0.0/core/interpolation/BasicExample';
