...
import Code_modifier_withDecay_BasicExample from '!!raw-loader!@site/src/examples/6.0.0/modifier/withDecay/BasicExample.tsx';
import Demo_modifier_withDecay_BasicExample from '@site/src/examples/6.0.0/modifier/withDecay/BasicExample';
