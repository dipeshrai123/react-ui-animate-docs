...
import Code_modifier_withParallel_BasicExample from '!!raw-loader!@site/src/examples/6.0.0/modifier/withParallel/BasicExample.tsx';
import Demo_modifier_withParallel_BasicExample from '@site/src/examples/6.0.0/modifier/withParallel/BasicExample';
